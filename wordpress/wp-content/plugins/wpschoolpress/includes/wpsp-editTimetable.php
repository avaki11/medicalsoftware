			...
			<div class="wpsp-card">
				...
				<div class="wpsp-card-body">
								...
								<tr style="background: transparent;">
									<?php
										foreach ($clt as $id) {
											...
											echo '<div class="removesubject"><div class="item" id="' . $id->id . '" style="width:auto; color:#5cb85c; font-weight:500;">' . $id->sub_name . '</div>	</div>';
										}
									?>
								</tr>
								</tbody>
					...
					echo '<div class="removesubject">
						<div class="item" id="' . $id->id . '" style="width:auto; color:#5cb85c; font-weight:500;">' . $id->sub_name . '
						</div>	
					</div>';
					}
					?>
						...
						<div class="right wpsp-table-responsive" id="TimetableContainer">
							<table class="wpsp-table wpsp-table-bordered" cellspacing="0" width="100%" style="width:100%">
								...
								<tbody>
									...
									for ($j = 1; $j <= 7; $j++) { ?>
										<tr id="<?php echo $j; ?>">
											<td><!-- <span class="dayval">Day <?php echo $j; ?></span> --><span class="daynam"><?php echo $dayname[$j - 1]; ?></span> </td>
											<?php
											$subida = array(); 
											 $subida1 = array(); 
											  $subtimesloat = array();
                ...
                //                                print_r($sub_name_f);   
												...
												if( !empty( $sub_name ) ) {
													if($td_class == "break"){
													$sub_name	=	'<div class="item1 assigned wpsp-assigned-item">Break<a href="javascript:void(0)" class="" data-id='. $key.' data-rowid='.$j.'  ></a></div>';	
													} else {
 														if($subida1[$pa] == 1){
                                                $sub_name = '-';
                                                    } else {
                                                        $sub_name	=	'<div class="item1 assigned wpsp-assigned-item">'. $sub_name.'<a href="javascript:void(0)" class="daleteid wpsp-tt-delete-icon" data-id='. $key.' data-rowid='.$j.'  ></a></div>';
                                                    }
