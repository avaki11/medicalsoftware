...
<form name="StudentEntryForm" id="StudentEntryForm" method="POST" enctype="multipart/form-data"><div class="wpsp-col-xs-12">
    ...
    <div class="wpsp-card">
                <div class="wpsp-card-head">
                    <h3 class="wpsp-card-title"><?php echo apply_filters( 'wpsp_student_title_personal_detail', esc_html__( 'Patient Details', 'WPSchoolPress' )); ?></h3>
                </div>
 ...
 || event.keyCode == 37 || event.keyCode == 39 || event.charCode >= 48 && event.charCode <= 57'>
      ...
      <div class="wpsp-row">
       <div class="wpsp-col-xs-12">
        <div class="wpsp-card">
            <div class="wpsp-card-head">
                <h3 class="wpsp-card-title"><?php echo apply_filters( 'wpsp_student_title_parent_detail', esc_html__( 'Doctors Detail', 'WPSchoolPress' )); ?></h3>
            </div>
            <div class="wpsp-card-body">
                <div class="wpsp-row">
