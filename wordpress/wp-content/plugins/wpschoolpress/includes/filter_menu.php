...
$sch_classes = apply_filters('wpsp_sidebar_classes_title_menu',esc_html__('Injuries/Sickness','WPSchoolPress'));
$sch_subject = apply_filters('wpsp_sidebar_subject_title_menu',esc_html__('Type Inury/Sickness','WPSchoolPress'));
$sch_subject_mark_field = apply_filters('wpsp_sidebar_subField_title_menu',esc_html__('Subject Mark Fields','WPSchoolPress'));
$sch_marks = apply_filters('wpsp_sidebar_marks_title_menu',esc_html__('Progression','WPSchoolPress'));
$sch_exams = apply_filters('wpsp_sidebar_exams_title_menu',esc_html__('Results','WPSchoolPress'));
$sch_timetable = apply_filters('wpsp_sidebar_timetable_title_menu',esc_html__('Appointments','WPSchoolPress'));
$sch_attendance = apply_filters('wpsp_sidebar_attendance_title_menu',esc_html__('Appointments','WPSchoolPress'));
$sch_student_attendance = apply_filters('wpsp_sidebar_student_attendance_title_menu',esc_html__('Patient Appointments','WPSchoolPress'));
