...
$sid = get_current_user_id();
 $tinfo = $wpdb->get_row("select teacher.*,user.user_email from $teacher_table teacher LEFT JOIN $users_table user ON user.ID=teacher.wp_usr_id where teacher.wp_usr_id='$sid'");
if( !empty( $stinfo ) ) {
 ...
 if($current_user_role == 'parent'){
       $stinfo = $wpdb->get_row("select * from $student_table where parent_wp_usr_id='$sid'");
       $loc_avatar=get_user_meta($sid,'simple_local_avatar',true);
       $img_url= $loc_avatar ? $loc_avatar['full'] : WPSP_PLUGIN_URL.'img/default_avtar.jpg';
}
?>
                        ...
                        <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
                            <div class="wpsp-form-group">
                                ...
                                <div class="wpsp-profileUp">
                                    ...
                                    $img_url    =   $loc_avatar ? $loc_avatar['full'] : WPSP_PLUGIN_URL.'img/default_avtar.jpg';
                                    ?>
                                    <img class="wpsp-upAvatar" id="img_preview" src="<?php echo $img_url;?>">
        ...
        <div class="wpsp-card">
            ...
            <div class="wpsp-card-body">
                    ...
                    <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
                        ...
                        <input type="hidden" id="studID" name="wp_usr_id" value="<?php echo $sid;?>">
                        <input type="hidden" name="parentid" value="<?php echo $stinfo->parent_wp_usr_id;?>">
                         <input type="hidden" id="" name="s_fname" value="<?php echo $stinfo->s_fname;?>">
                          <input type="hidden" id="" name="s_lname" value="<?php echo $stinfo->s_lname;?>">
                    <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
                        <div class="wpsp-form-group">
